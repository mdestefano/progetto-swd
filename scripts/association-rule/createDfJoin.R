...
dirs <- list.dirs(path = "C:\\Users\\Grazia\\Desktop\\SD\\progetto-swd\\scripts\\datasets\\designite", full.names = TRUE, recursive = TRUE)
dirs = dirs[-1]
...
dirs <- list.dirs(path = "C:\\Users\\Grazia\\Desktop\\SD\\progetto-swd\\scripts\\datasets\\risultatiTest", full.names = TRUE, recursive = TRUE)
dirs = dirs[-1]
